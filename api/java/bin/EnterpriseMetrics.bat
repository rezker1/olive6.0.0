...
%JAVACMD% %JAVA_OPTS% -Xms4096m -classpath %CLASSPATH% -Dapp.name="EnterpriseMetrics" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.sri.speech.olive.metrics.EnterpriseMetrics %CMD_LINE_ARGS%
