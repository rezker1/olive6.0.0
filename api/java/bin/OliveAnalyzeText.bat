...
%JAVACMD% %JAVA_OPTS% -Xms4096m -classpath %CLASSPATH% -Dapp.name="OliveAnalyzeText" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.sri.speech.olive.api.client.OliveAnalyzeText %CMD_LINE_ARGS%
