...
%JAVACMD% %JAVA_OPTS% -Xms4096m -classpath %CLASSPATH% -Dapp.name="OliveEnroll" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.sri.speech.olive.api.client.OliveEnroll %CMD_LINE_ARGS%
