...
%JAVACMD% %JAVA_OPTS% -Xms4096m -classpath %CLASSPATH% -Dapp.name="OliveLearn" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.sri.speech.olive.api.client.OliveLearn %CMD_LINE_ARGS%
